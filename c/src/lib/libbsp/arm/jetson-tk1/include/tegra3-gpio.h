...
#define GPIO1_IRQ		(1 << ((32 + 32) % 32))
#define GPIO2_IRQ		(1 << ((33 + 32) % 32))
#define GPIO3_IRQ		(1 << ((34 + 32) % 32))
#define GPIO4_IRQ		(1 << ((35 + 32) % 32))
#define GPIO5_IRQ		(1 << ((55 + 32) % 32))
#define GPIO6_IRQ		(1 << ((87 + 32) % 32))
#define GPIO7_IRQ		(1 << ((89 + 32) % 32))
#define GPIO8_IRQ		(1 << ((125 + 32) % 32))

static const uint8_t gpio_vector_table[] = {
  GPIO1_IRQ,
  GPIO2_IRQ,
  GPIO3_IRQ,
  GPIO4_IRQ,
